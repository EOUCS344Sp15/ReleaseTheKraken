...
public class MapBodyManager
{
     ...
     * @param materialsFile json file with specific physics properties to be
     * assigned to newly created bodies.
    ...
    /**
     * @param map will use the "physics" layer of this map to look for shapes in
