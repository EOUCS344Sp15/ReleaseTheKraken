...
public class EntityWaterSquirt extends EntityProjectile
{
    ...
    {
        this(world, xLoc, yLoc, xVel, yVel, owner, damage, 16*60);
    }

    public EntityWaterSquirt(GameWorld world, float xLoc, float yLoc, float xVel, float yVel, Entity owner, int damage, int despawnTimer)
    {
