...
public class SeaCreaturePath
{
    ...
    public SeaCreaturePath(int id, SeaCreaturePath parent, Array<SeaCreaturePath> nextPaths, Polyline polyline)
    {
        ...
        Vector2 lastPoint = points[points.length-1].cpy().add(points[points.length-1].cpy().sub(points[points.length-2]));
    ...
    /**
     * Gets the smooth path generated by this object
     * @return The CatmullRomSpline smooth path
     */
    public CatmullRomSpline getSmoothPath()
    {
        return this.path;
    }
